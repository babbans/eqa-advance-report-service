...
import com.eqa.eqaaprsummaryservice.repository.AnnualProgramReportSettingRepository;
import com.eqa.eqaaprsummaryservice.util.CommonUtils;
...
//            existingSetting.setUpdateBy(username);
    ...
    public ResponseEntity<ResponseObject> deleteSetting(List<Long> ids) throws CustomException {
        try {
            settingRepository.softDelete(ids);
